...
## Do perceptions track reality?

```{r perceptions}

mod1 <- felm(data = df, 
             localFairShare ~ distance_scale + p_edlevel + age + male + 
               p_socgrade + p_gross_household + leftRight + is_white | 
               region | 0 | region)

mod2 <- felm(data = df, 
             londonFairShare ~ distance_scale + p_edlevel + age + male + 
               p_socgrade + p_gross_household + leftRight + is_white | 
               region | 0 | region)
mod3 <- felm(data = df, 
             london_local_fair_share ~ distance_scale + p_edlevel + age + male + 
               p_socgrade + p_gross_household + leftRight + is_white | 
               region | 0 | region)
mod4 <- felm(data = df, 
             areaRichPoor_scale ~ distance_scale + p_edlevel + age + male + 
               p_socgrade + p_gross_household + leftRight + is_white | 
               region | 0 | region)

mod5 <- felm(data = df, 
             redistSelf ~ distance_scale + p_edlevel + age + male + 
               p_socgrade + p_gross_household + leftRight + is_white | 
               region | 0 | region)

summary(felm(data = df, areaRichPoor_scale ~ distance_scale*imd_score + 
               p_edlevel + age + male + p_socgrade + p_gross_household + leftRight + 
               is_white | region | 0 | region))
